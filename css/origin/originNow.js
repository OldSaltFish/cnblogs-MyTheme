(function ($) {
    ...
    class Silence {
        ...
        constructor() {
            this.defaluts = {
                ...
                sponsor: {
                    ...
                    paypal: null,
                    // 修改处
                    wechat: 'https://i.mij.rip/2023/11/01/2367aa0957f868d417ead827d7cf92a9.png',
                    alipay: 'https://i.mji.rip/2023/11/01/9bb559d3c589d7182497010b13006c94.jpeg'
                },
                github: {
                    enable: false,
                    color: '#fff',
                ...
                topImg: {
                    homeTopImg: [
                        "https://i.mji.rip/2023/11/01/2acbb2cacb926710eea54210e5f79191.jpeg",
                    ],
                    notHomeTopImg: [
                        "https://i.mji.rip/2023/11/01/2acbb2cacb926710eea54210e5f79191.jpeg"
                    ]
        ...
        buildCustomElements() {
            ...
            //回到顶部特效
            $('body').prepend(`<a href="javascript:;" class="cd-top faa-float animated cd-fade-out"></a>`);
            $('.cd-top').click(function() {
                $('html, body').animate({
                    scrollTop: 0
                }, 1000); // 1000代表1秒内滚动到顶部，你可以根据需求调整这个数值
            });
            let $win = $(window);
            let oldScrollY = 0;
            $win.scroll(function () {
...
//修改处 改成自己的友链,去除了赞赏页
            // <li><a id="blog_nav_myzanshang" class="menu" href="https://www.cnblogs.com/zouwangblog/articles/11340077.html">赞赏</a><i></i></li>
            $("#navList").append('<li><a id="blog_nav_myyoulian" class="menu" href="https://www.cnblogs.com/oldsaltfish/articles/17802186.html">友链</a><i></i></li><li><a id="blog_nav_myguanyu" class="menu" href="https://www.cnblogs.com/oldsaltfish/articles/17802192.html">关于</a><i></i></li>');
            //添加标签icon
...
// 剩余部分
        ...
        buildBloggerProfile() {
            ...
            <div class="site-branding">
                <a href="https://www.cnblogs.com/oldsaltfish/" alt="主页">
                    <div>
                        <h1>魂祈梦</h1>
                        <img src="https://s2.loli.net/2024/03/31/pVnuRXbAEfvONDP.png" alt=""/>
                    </div>
                </a>
            </div>
            `;
        ...
        for(let i = article_list.length-1;i>=0;i--)
        {
            ...
            for(let j=PostTitles.length-1;j>=0;j--)
            {
                ...
                if(url!=undefined)
                {
                    ...
                    // 文章默认封面
                    url = url = 'https://blog-static.cnblogs.com/files/blogs/806667/cnblogPostBanner.gif';
                }
        ...
        postHeader() {
            ...
            if (window.location.href.indexOf('articles') === -1) {
                var header =
                        `<p class="entry-census"><span><a href="https://www.cnblogs.com/oldsaltfish/"><img src="https://i.mji.rip/2023/11/01/79d2278d49510100c081c4c85dfcbd5b.jpeg"></a></span><span><a href="https://www.cnblogs.com/oldsaltfish/">Oldsaltfish</a></span><span class="bull">·</span>${post_date}<span class="bull">·</span>${post_view_count} 次阅读</p>`;
